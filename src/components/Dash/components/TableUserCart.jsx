...
function TableUserCart({ cartsUser, isLoading, allBranches }) {

    const { salesDataCopy, selectedId, setsalesDataCopy, selectedClient, selectedBranch, selectedStatus, selectedType, changeFlter, changeFlterBranch, changeFlterClient, changeFlterState, changeFlterType } = useFilterData({ cartsUser })
    ...
    useEffect(() => {
        setWaiterName(cartsUser[0]?.user)
    }, [cartsUser])
    ...
    // if (isLoading || cartsUser.length === 0) {
    //     return <div>
    //       <l-dot-spinner
    //         size="40"
    //         speed="1.1"
        ...
        <>
            <div className=" p-1 mt-3">
                ...
                <h3 className='card-title mb-2 p-1'>
                    <span className='fs-4 '>Mesero:</span>
                    <span className='fs-4 text-uppercase'>{' ' + waiterName?.firstName + ' ' + waiterName?.lastName}</span>
                </h3>
